...
class MPC {
public:
    MPCReturn runMPC(State &x0, int n, int model_type);
...
private:
    ...
    void setMPCProblem(int model_type);

    void setStage(const State &xk, const Input &uk, int time_step, int model_type);
